...
def startVersionCheck(id, password) :
    version(id, password)

def buyMarketOrder(itemCode, stockAmount, buyOrSell):
...
def sellMarketOrder(itemCode, stockAmount, buyOrSell):
    accounts = kiwoom.GetLoginInfo("ACCNO")
